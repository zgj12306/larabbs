      ...
      <div class="card-body">
        ...
        @endif
          ...
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    <label for="last_reply_user-field">Last_reply_user</label>
                    <input class="form-control" type="text" name="last_reply_user" id="last_reply_user-field" value="{{ old('last_reply_user', $topic->last_reply_user ) }}" />
                </div> 
                <div class="form-group">
